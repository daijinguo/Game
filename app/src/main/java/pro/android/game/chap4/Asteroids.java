...
public class Asteroids extends ArcadeGame {
    ...
    void loadSounds() {
        ...
        crashSound = new AudioClip(ctx, R.raw.pro_andoir_game_chap4_a_crash);
        clipTotal++;
        explosionSound = new AudioClip(ctx, R.raw.pro_andoir_game_chap4_a_explosion);
        clipTotal++;
        fireSound = new AudioClip(ctx, R.raw.pro_andoir_game_chap4_a_fire);
        clipTotal++;
        missileSound = new AudioClip(ctx, R.raw.pro_andoir_game_chap4_a_missle);
        clipTotal++;
        saucerSound = new AudioClip(ctx, R.raw.pro_andoir_game_chap4_a_saucer);
        clipTotal++;
        thrustersSound = new AudioClip(ctx, R.raw.pro_andoir_game_chap4_a_thrusters);
        clipTotal++;
        warpSound = new AudioClip(ctx, R.raw.pro_andoir_game_chap4_a_warp);
        clipTotal++;
    }
